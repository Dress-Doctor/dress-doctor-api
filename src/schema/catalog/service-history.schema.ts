...
export const serviceHistorySchemaName = 'service_history';

/**
 * The audit trail of one service row — its name, description and status.
 *
 ...
 */
@Schema({ timestamps: true, collection: serviceHistorySchemaName })
export class ServiceHistory extends Document<Types.ObjectId> {
  @Prop({
    index: true,
    required: true,
    type: Types.ObjectId,
